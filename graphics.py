...
class Rectangle(_BBox):
    ...
    def getXp1(self): # Petrus modificaction, 03-10-17
        return self.p1.getX()
...
class Circle(Oval):
    ...
    def getXcirc(self): # Petrus modificaction, 03-10-17
        return self.p1.getX() + self.radius
    
    def getYcirc(self): # Petrus modificaction, 03-10-17
        return self.p1.getY() + self.radius
